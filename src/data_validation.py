...
if __name__=='__main__':
    data_ingestion_artifact = DataIngestionArtifact(trained_file_path='artifact\\05_27_2025_20_41_21\\data_ingestion\\ingested\\train.csv',test_file_path='artifact\\05_27_2025_20_41_21\\data_ingestion\\ingested\\test.csv')
    data_validation_config = DataValidationConfig()
    data_validator = DataValidation(data_ingestion_artifact=data_ingestion_artifact,data_validation_config=data_validation_config)
    res = data_validator.initiate_data_validation()
    print(res)
